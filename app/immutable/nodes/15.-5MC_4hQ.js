import{c as ae,a as V,b as z,l as oe,t as j,r as ie}from"../chunks/BSrr2iHZ.js";import{p as le,d as x,e as B,f as de,s as r,c as i,g as t,a as ne,i as n,F as $,r as o,b as k}from"../chunks/DFh4qjIG.js";import{d as se}from"../chunks/C1OZPYWU.js";import{e as N,i as S}from"../chunks/DmXpugoF.js";import{S as ce,r as p}from"../chunks/CIsLWsSN.js";import{b as v,v as y}from"../chunks/BuHwc_3M.js";w[$]="src/routes/tools/meeting-notes/+page.svelte";function ve(b,l){n(l,[...t(l),{id:crypto.randomUUID(),name:""}],!0)}function ue(b,l){n(l,[...t(l),{id:crypto.randomUUID(),name:""}],!0)}function pe(b,l){n(l,[...t(l),{id:crypto.randomUUID(),topic:"",subPoints:[""]}],!0)}function be(b,l){n(l,[...t(l),{id:crypto.randomUUID(),topic:"",points:[""]}],!0)}function ge(b,l){n(l,[...t(l),{id:crypto.randomUUID(),task:"",owner:"",dueDate:"",notes:""}],!0)}function me(b,l){n(l,[...t(l),{id:crypto.randomUUID(),description:""}],!0)}function xe(b,l,c,G,F,O,q,K,I,U,_,f,E,L,Y){const Z=`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="metadata">
        ...
        <p><strong>Meeting Goal/Purpose:</strong> ${t(q)}</p>
    </div>

    <h2>Attendees</h2>
    <ul>
        ${t(K).map(u=>`<li>${u.name}</li>`).join("")}
    </ul>
